...
def generate_branding_pdf_report(report_path, brand_name, category, analysis_results):
    ...
    story.append(Paragraph(f"AI Typography & Branding Intelligence Report", style_cover_title))
    ...
    draw.add(String(20, 75, "AI AGENT ORCHESTRATION LAYER: VERIFIED", fontName="Helvetica-Bold", fontSize=14, fillColor=c_primary))
    ...
    story.append(Paragraph("CONFIDENTIAL | GENERATED BY ANTIGRAVITY BRANDING ENGINE", style_body))
    ...
    story.append(Paragraph(
        ...
        "the AI Planners. The system analyzed brand values against our Design Knowledge Graph to identify high-impact recommendations.",
        style_body
    ))
